				...
				<div class="col-md-12 column">
					...
					<div class="page-header text-center">
						<a href="${host}" style="text-decoration : none"><h1>
							Zookeeper Console <#--<small>简单一点 方便一点</small>-->
						</h1></a>
					</div>
			...
			<div class="row clearfix">
				<div class="col-md-4 column">
					...
					<table class="table table-bordered">
						...
						<#else>
						<div class="alert"><h3 class="text-danger text-center">无子节点</h3></div>
						</#if>
					</table>
				</div>
				<div class="col-md-4 column">
      ...
      <div class="modal-body">
          <form class="form col-md-12 center-block" action="${host}/login" method="POST">
            ...
            <div class="form-group">
              ...
              <span class="pull-left">帐号的配置在resources/conf/user.properties</span><#--<span><a href="#">Need help?</a></span>-->
            </div>
          </form>
      </div>
